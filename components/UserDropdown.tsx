...
const UserDropdown = () => {
    ...
    const user = { name: 'Prathin Sajith', email: 'prathinsajith@example.com' };
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className='flex ite-center gap-3 text-gray-4 hover:text-yellow'>
                    <Avatar className='h-10 w-10'>
                        <AvatarImage src="https://avatars.githubusercontent.com/u/26500717?v=4" />
